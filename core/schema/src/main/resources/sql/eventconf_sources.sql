...
INSERT INTO eventconf_sources(id, name, description, vendor, file_order, enabled, event_count, created_time, last_modified, uploaded_by) VALUES (15, 'opennms.pollerd.events', '', 'opennms', 9, true, 45, CURRENT_TIMESTAMP , CURRENT_TIMESTAMP , 'system-migration');
