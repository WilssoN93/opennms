...
public class IPAddressTest {
    ...
    @Test
    public void shouldParseIpv4BoundaryAddressesViaFastPath() {
        assertArrayEquals(new byte[] {(byte) 255, (byte) 255, (byte) 255, (byte) 255},
                new IPAddress("255.255.255.255").toOctets());
        assertArrayEquals(new byte[] {0, 0, 0, 0}, new IPAddress("0.0.0.0").toOctets());
        assertEquals("127.0.0.1", new IPAddress("127.0.0.1").toDbString());
    }
