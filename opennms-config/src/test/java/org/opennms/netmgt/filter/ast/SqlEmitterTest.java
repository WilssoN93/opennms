...
public class SqlEmitterTest {
    ...
    @Test
    public void catincEmitsExists() throws FilterParseException {
    ...
    @Test
    public void catincInEmitsExistsWithIn() throws FilterParseException {
    ...
    @Test
    public void notEmitsNot() throws FilterParseException {
        Expr e = new NotExpr(new CatincExpr("DMZ"));
        String sql = emit(e);
        assertNotNull(sql);
    ...
    @Test
    public void catincAndInEmitsSingleExistsWithMultipleJoins() throws FilterParseException {
